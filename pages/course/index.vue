      ...
      <section class="c-sort-box">
        ...
        <div class="mt40">
          ...
          <article v-if="data.total>0" class="comm-course-list">
              <ul id="bna" class="of">
                  <li v-for="item in data.allLimitCourse" :key="item.id">
                      <div class="cc-l-wrap">
...
<script>
import course from '@/api/course/index.js'
...
export default {
  ...
  methods: {
    //查询课程列表
    initCourse(){
      course.selectIfLimitCourse(1, 8,this.searchObj).then(response => {
    ...
    gotoPage(page) {
      this.page = page
      course.selectIfLimitCourse(page, 8, this.searchObj).then(response => {
        this.data = response.data.data
      })
    }
  }
